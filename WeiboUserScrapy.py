...
class WeiboUserScrapy:
    def __init__(self, user_id, filter=0):
        global headers
        self.headers = {"Cookie": Cookie, "User_Agent": User_Agent}
    ...
    def get_one_weibo(self, info):
        ...
        try:
            ...
            if (not self.filter) or is_original:
                ...
                weibo["link"] = "https://weibo.cn/comment/{}?uid={}&rl=0#cmtfrm".format(
                    weibo["id"], self.user_id
                )
    ...
    def write_csv(self, wrote_num):
        ...
        try:
            ...
            print("%d条微博写入csv文件完毕,保存路径:" % self.got_num)
        except Exception as e:
            print("Error: ", e)
            traceback.print_exc()
